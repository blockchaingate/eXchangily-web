...
contract BliBliToken is StandardToken, SafeMath {
    ...
    // metadata
    string  public constant name = "EAB";
...
--------------------- 
版权声明：本文为CSDN博主「JAVA_HHHH」的原创文章，遵循CC 4.0 by-sa版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/JAVA_HHHH/article/details/79771752