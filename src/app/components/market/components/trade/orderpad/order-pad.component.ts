...
import { TransactionResp } from '../../../../../models/kanban.interface';
...
export class OrderPadComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  generateOrderHash(bidOrAsk: boolean, orderType: string, baseCoin: any, targetCoin: any, amount: number, price: number, timeBeforeExpiration: any) {
    const randomString = Array.from(randombytes(32)).map(String).join('');
