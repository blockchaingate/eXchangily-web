...
import { BindpayComponent } from '../../bindpay/bindpay.component';

@Component({
    selector: 'app-myorders',
    standalone: true,
    imports: [CommonModule, TranslateModule, MatIconModule, FormsModule, MatRadioModule, PinNumberModal, BindpayComponent],
...
export class MyordersComponent implements OnInit, OnDestroy {
    ...
    orderHash = '';
    pair = '';
    modalWithdrawRef: BsModalRef = {} as BsModalRef;
    orderStatus = '';
    kanbanBalance = 0;
    mytokens: any;
    opType = '';
    ...
    withdrawModal: TemplateRef<any> = {} as TemplateRef<any>;
    interval = 0;
    transFeeAdvance = 0.0;
    ...
    async ngOnInit() {
        ...
        if (this.wallet) {
            this.storage.getIsMobile().subscribe(isMobile => {
                if (!isMobile) {
                    ...
                    const exaddr = new AddressProcessor();
    ...
    async openWithdrawModal(template: TemplateRef<any>) {
        ...
        if (this.coinName == 'USDT') {
            ...
            try {
                const coinWithdrawConfig = environment.minimumWithdraw[this.coinName as keyof typeof environment.minimumWithdraw];
                this.minimumWithdrawAmount = (coinWithdrawConfig && typeof coinWithdrawConfig === 'object' && this.chain in coinWithdrawConfig
                    ? coinWithdrawConfig[this.chain as keyof typeof coinWithdrawConfig]
                    : 0) ?? 0;
            ...
            this.chain = 'FAB';
            try {
                this.minimumWithdrawAmount = environment.minimumWithdraw[this.coinName][this.chain as keyof (typeof environment.minimumWithdraw)[typeof this.coinName]];
            ...
            this.chain = 'FAB';
            try {
                this.minimumWithdrawAmount = ((environment.minimumWithdraw[this.coinName] as unknown) as Record<string, number>)[this.chain];
            ...
            this.chain = 'FAB';
            try {
                this.minimumWithdrawAmount = environment.minimumWithdraw['EXG'][this.chain as keyof typeof environment.minimumWithdraw['EXG']];
            ...
            this.chain = 'FAB';
            try {
                this.minimumWithdrawAmount = environment.minimumWithdraw['DSC'][this.chain as keyof typeof environment.minimumWithdraw['DSC']];
            ...
            this.chain = 'FAB';
            try {
                this.minimumWithdrawAmount = environment.minimumWithdraw['BST'][this.chain as keyof typeof environment.minimumWithdraw['BST']];
            ...
            this.minimumWithdrawAmount = environment.minimumWithdraw[this.coinName as keyof typeof environment.minimumWithdraw] as number;
        }
    ...
    showBalance(balance: number, decimals: number) {
    ...
    showFilledPercentage(orderQty: number, orderFilledQty: number) {
